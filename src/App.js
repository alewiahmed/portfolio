...
class App extends Component {
  state = {
    ...
    address: [
      ...
      {
        name: 'codepen',
        link: 'https://codepen.io/alewiahmed'
      }
    ]
  };
  ...
  showWorks = () => {
    ...
    return (
      <div className="container px-4 mb-5 single-page bk-dark-blue" id="works">
        <div className="row h-100">
          <div className="col-12">
            <div className="d-flex align-items-center justify-content-center">
              <h1 className="text-center header my-4">Works</h1>
            </div>
          </div>
    ...
    return (
      <div className="container px-5 single-page bk-dark-blue" id="contact">
        <div className="row h-100">
          <div className="col-12">
            <div className="d-flex align-items-center justify-content-center">
              <h1 className="text-center header my-4">Contact</h1>
            </div>
          </div>
  ...
  showSkills = () => {
    return (
      <div className="container px-5 mb-5 single-page bk-dark-blue" id="skills">
        <div className="row h-100">
          <div className="d-flex col-12 align-items-center justify-content-center">
            <h1 className="text-center header my-4">Skills</h1>
          </div>
          <div className="col-md col-12 h-auto align-items-center justify-content-center">
            <h3>Languages</h3>
  ...
  showFrontPage = () => {
    return (
      ...
      >
        <div className="container p-4 h-100 d-flex align-items-center justify-content-center">
